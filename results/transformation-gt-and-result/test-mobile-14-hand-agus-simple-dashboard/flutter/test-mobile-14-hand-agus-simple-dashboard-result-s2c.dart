...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const TestMobile14HandAgusSimpleDashboardResultS2cJson(),
    );
  }
}

class TestMobile14HandAgusSimpleDashboardResultS2cJson extends StatelessWidget {
  const TestMobile14HandAgusSimpleDashboardResultS2cJson({super.key});
