...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const TestMobile15HandTiaBrowseProductsResultYolov11Json(),
    );
  }
}

class TestMobile15HandTiaBrowseProductsResultYolov11Json extends StatelessWidget {
  const TestMobile15HandTiaBrowseProductsResultYolov11Json({super.key});
