...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const TestMobile14HandPazrinSimpleDashboardResultS2cJson(),
    );
  }
}

class TestMobile14HandPazrinSimpleDashboardResultS2cJson extends StatelessWidget {
  const TestMobile14HandPazrinSimpleDashboardResultS2cJson({super.key});
