...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const TestDesktop10BrowseProductResultS2cJson(),
    );
  }
}

class TestDesktop10BrowseProductResultS2cJson extends StatelessWidget {
  const TestDesktop10BrowseProductResultS2cJson({super.key});
