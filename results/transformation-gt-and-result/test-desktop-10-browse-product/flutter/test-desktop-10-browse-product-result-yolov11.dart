...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const TestDesktop10BrowseProductResultYolov11Json(),
    );
  }
}

class TestDesktop10BrowseProductResultYolov11Json extends StatelessWidget {
  const TestDesktop10BrowseProductResultYolov11Json({super.key});
