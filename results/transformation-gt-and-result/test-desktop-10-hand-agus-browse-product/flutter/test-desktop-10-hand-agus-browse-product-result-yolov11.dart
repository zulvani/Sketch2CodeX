...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const TestDesktop10HandAgusBrowseProductResultYolov11Json(),
    );
  }
}

class TestDesktop10HandAgusBrowseProductResultYolov11Json extends StatelessWidget {
  const TestDesktop10HandAgusBrowseProductResultYolov11Json({super.key});
