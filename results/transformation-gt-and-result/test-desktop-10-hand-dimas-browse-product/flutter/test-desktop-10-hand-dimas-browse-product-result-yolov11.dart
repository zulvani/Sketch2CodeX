...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const TestDesktop10HandDimasBrowseProductResultYolov11Json(),
    );
  }
}

class TestDesktop10HandDimasBrowseProductResultYolov11Json extends StatelessWidget {
  const TestDesktop10HandDimasBrowseProductResultYolov11Json({super.key});
