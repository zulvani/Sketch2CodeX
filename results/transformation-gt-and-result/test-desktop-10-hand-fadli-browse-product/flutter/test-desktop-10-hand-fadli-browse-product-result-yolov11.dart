...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const TestDesktop10HandFadliBrowseProductResultYolov11Json(),
    );
  }
}

class TestDesktop10HandFadliBrowseProductResultYolov11Json extends StatelessWidget {
  const TestDesktop10HandFadliBrowseProductResultYolov11Json({super.key});
