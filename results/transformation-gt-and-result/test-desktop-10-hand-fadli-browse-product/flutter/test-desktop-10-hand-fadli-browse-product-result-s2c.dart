...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const TestDesktop10HandFadliBrowseProductResultS2cJson(),
    );
  }
}

class TestDesktop10HandFadliBrowseProductResultS2cJson extends StatelessWidget {
  const TestDesktop10HandFadliBrowseProductResultS2cJson({super.key});
