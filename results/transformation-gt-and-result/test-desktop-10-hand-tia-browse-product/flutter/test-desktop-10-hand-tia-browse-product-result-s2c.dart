...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const TestDesktop10HandTiaBrowseProductResultS2cJson(),
    );
  }
}

class TestDesktop10HandTiaBrowseProductResultS2cJson extends StatelessWidget {
  const TestDesktop10HandTiaBrowseProductResultS2cJson({super.key});
