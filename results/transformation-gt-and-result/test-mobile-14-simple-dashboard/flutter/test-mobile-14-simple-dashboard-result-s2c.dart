...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const TestMobile14SimpleDashboardResultS2cJson(),
    );
  }
}

class TestMobile14SimpleDashboardResultS2cJson extends StatelessWidget {
  const TestMobile14SimpleDashboardResultS2cJson({super.key});
