...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const TestMobile14SimpleDashboardResultSdnJson(),
    );
  }
}

class TestMobile14SimpleDashboardResultSdnJson extends StatelessWidget {
  const TestMobile14SimpleDashboardResultSdnJson({super.key});
