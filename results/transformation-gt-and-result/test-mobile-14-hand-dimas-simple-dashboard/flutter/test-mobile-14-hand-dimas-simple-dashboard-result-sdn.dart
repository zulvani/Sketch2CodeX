...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const TestMobile14HandDimasSimpleDashboardResultSdnJson(),
    );
  }
}

class TestMobile14HandDimasSimpleDashboardResultSdnJson extends StatelessWidget {
  const TestMobile14HandDimasSimpleDashboardResultSdnJson({super.key});
