...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const TestMobile15HandAgusBrowseProductsResultSdnJson(),
    );
  }
}

class TestMobile15HandAgusBrowseProductsResultSdnJson extends StatelessWidget {
  const TestMobile15HandAgusBrowseProductsResultSdnJson({super.key});
