...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const TestMobile15HandAgusBrowseProductsResultYolov11Json(),
    );
  }
}

class TestMobile15HandAgusBrowseProductsResultYolov11Json extends StatelessWidget {
  const TestMobile15HandAgusBrowseProductsResultYolov11Json({super.key});
