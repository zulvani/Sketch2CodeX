...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const TestDesktop4DssRunAhpResultYolov11Json(),
    );
  }
}

class TestDesktop4DssRunAhpResultYolov11Json extends StatelessWidget {
  const TestDesktop4DssRunAhpResultYolov11Json({super.key});
