...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const TestDesktop10HandPazrinBrowseProductResultSdnJson(),
    );
  }
}

class TestDesktop10HandPazrinBrowseProductResultSdnJson extends StatelessWidget {
  const TestDesktop10HandPazrinBrowseProductResultSdnJson({super.key});
