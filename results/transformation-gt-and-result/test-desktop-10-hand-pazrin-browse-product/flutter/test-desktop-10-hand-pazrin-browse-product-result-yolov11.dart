...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const TestDesktop10HandPazrinBrowseProductResultYolov11Json(),
    );
  }
}

class TestDesktop10HandPazrinBrowseProductResultYolov11Json extends StatelessWidget {
  const TestDesktop10HandPazrinBrowseProductResultYolov11Json({super.key});
