...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const TestMobile14HandFadliSimpleDashboardResultYolov11Json(),
    );
  }
}

class TestMobile14HandFadliSimpleDashboardResultYolov11Json extends StatelessWidget {
  const TestMobile14HandFadliSimpleDashboardResultYolov11Json({super.key});
