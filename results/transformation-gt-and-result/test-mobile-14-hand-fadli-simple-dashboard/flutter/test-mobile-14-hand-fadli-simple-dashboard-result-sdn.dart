...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const TestMobile14HandFadliSimpleDashboardResultSdnJson(),
    );
  }
}

class TestMobile14HandFadliSimpleDashboardResultSdnJson extends StatelessWidget {
  const TestMobile14HandFadliSimpleDashboardResultSdnJson({super.key});
