...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const TestMobile15HandTiaBrowseProductsResultSdnJson(),
    );
  }
}

class TestMobile15HandTiaBrowseProductsResultSdnJson extends StatelessWidget {
  const TestMobile15HandTiaBrowseProductsResultSdnJson({super.key});
