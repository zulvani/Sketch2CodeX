...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const TestMobile14HandAgusSimpleDashboardResultSdnJson(),
    );
  }
}

class TestMobile14HandAgusSimpleDashboardResultSdnJson extends StatelessWidget {
  const TestMobile14HandAgusSimpleDashboardResultSdnJson({super.key});
