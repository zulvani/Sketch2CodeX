...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const TestMobile14HandPazrinSimpleDashboardResultSdnJson(),
    );
  }
}

class TestMobile14HandPazrinSimpleDashboardResultSdnJson extends StatelessWidget {
  const TestMobile14HandPazrinSimpleDashboardResultSdnJson({super.key});
