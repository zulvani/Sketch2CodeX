...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const TestMobile14HandPazrinSimpleDashboardResultYolov11Json(),
    );
  }
}

class TestMobile14HandPazrinSimpleDashboardResultYolov11Json extends StatelessWidget {
  const TestMobile14HandPazrinSimpleDashboardResultYolov11Json({super.key});
