...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const TestMobile15HandDimasBrowseProductsResultYolov11Json(),
    );
  }
}

class TestMobile15HandDimasBrowseProductsResultYolov11Json extends StatelessWidget {
  const TestMobile15HandDimasBrowseProductsResultYolov11Json({super.key});
