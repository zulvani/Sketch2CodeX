...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const TestDesktop10HandAgusBrowseProductResultS2cJson(),
    );
  }
}

class TestDesktop10HandAgusBrowseProductResultS2cJson extends StatelessWidget {
  const TestDesktop10HandAgusBrowseProductResultS2cJson({super.key});
