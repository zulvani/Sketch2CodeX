...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const TestDesktop10HandAgusBrowseProductResultSdnJson(),
    );
  }
}

class TestDesktop10HandAgusBrowseProductResultSdnJson extends StatelessWidget {
  const TestDesktop10HandAgusBrowseProductResultSdnJson({super.key});
