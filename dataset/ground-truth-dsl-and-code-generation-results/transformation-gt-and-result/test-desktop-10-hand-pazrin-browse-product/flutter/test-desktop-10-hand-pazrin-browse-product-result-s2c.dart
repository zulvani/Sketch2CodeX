...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const TestDesktop10HandPazrinBrowseProductResultS2cJson(),
    );
  }
}

class TestDesktop10HandPazrinBrowseProductResultS2cJson extends StatelessWidget {
  const TestDesktop10HandPazrinBrowseProductResultS2cJson({super.key});
