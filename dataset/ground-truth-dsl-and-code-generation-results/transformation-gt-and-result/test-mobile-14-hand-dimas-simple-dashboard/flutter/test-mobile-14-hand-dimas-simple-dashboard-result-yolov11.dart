...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const TestMobile14HandDimasSimpleDashboardResultYolov11Json(),
    );
  }
}

class TestMobile14HandDimasSimpleDashboardResultYolov11Json extends StatelessWidget {
  const TestMobile14HandDimasSimpleDashboardResultYolov11Json({super.key});
