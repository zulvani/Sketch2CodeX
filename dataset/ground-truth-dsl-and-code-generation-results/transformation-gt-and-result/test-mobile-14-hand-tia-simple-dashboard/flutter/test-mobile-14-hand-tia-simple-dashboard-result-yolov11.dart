...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const TestMobile14HandTiaSimpleDashboardResultYolov11Json(),
    );
  }
}

class TestMobile14HandTiaSimpleDashboardResultYolov11Json extends StatelessWidget {
  const TestMobile14HandTiaSimpleDashboardResultYolov11Json({super.key});
