...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const TestDesktop10HandDimasBrowseProductResultS2cJson(),
    );
  }
}

class TestDesktop10HandDimasBrowseProductResultS2cJson extends StatelessWidget {
  const TestDesktop10HandDimasBrowseProductResultS2cJson({super.key});
