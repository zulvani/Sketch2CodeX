...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const TestDesktop10HandDimasBrowseProductResultSdnJson(),
    );
  }
}

class TestDesktop10HandDimasBrowseProductResultSdnJson extends StatelessWidget {
  const TestDesktop10HandDimasBrowseProductResultSdnJson({super.key});
