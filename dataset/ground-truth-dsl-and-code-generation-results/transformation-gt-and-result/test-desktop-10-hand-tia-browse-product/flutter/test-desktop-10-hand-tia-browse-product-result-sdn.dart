...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const TestDesktop10HandTiaBrowseProductResultSdnJson(),
    );
  }
}

class TestDesktop10HandTiaBrowseProductResultSdnJson extends StatelessWidget {
  const TestDesktop10HandTiaBrowseProductResultSdnJson({super.key});
