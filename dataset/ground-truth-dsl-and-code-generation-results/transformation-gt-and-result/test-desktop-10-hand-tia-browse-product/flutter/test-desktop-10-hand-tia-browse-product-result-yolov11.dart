...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const TestDesktop10HandTiaBrowseProductResultYolov11Json(),
    );
  }
}

class TestDesktop10HandTiaBrowseProductResultYolov11Json extends StatelessWidget {
  const TestDesktop10HandTiaBrowseProductResultYolov11Json({super.key});
