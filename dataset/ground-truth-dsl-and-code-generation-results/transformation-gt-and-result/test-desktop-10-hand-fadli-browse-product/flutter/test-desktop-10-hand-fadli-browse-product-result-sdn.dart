...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const TestDesktop10HandFadliBrowseProductResultSdnJson(),
    );
  }
}

class TestDesktop10HandFadliBrowseProductResultSdnJson extends StatelessWidget {
  const TestDesktop10HandFadliBrowseProductResultSdnJson({super.key});
