...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const TestMobile15HandFadliBrowseProductsResultYolov11Json(),
    );
  }
}

class TestMobile15HandFadliBrowseProductsResultYolov11Json extends StatelessWidget {
  const TestMobile15HandFadliBrowseProductsResultYolov11Json({super.key});
